    ...
    <>
      ...
      {showToast && (
        <div className="fixed top-4 right-4 z-50 animate-slide-in">
          <div className="bg-brand-blue text-white px-6 py-4 rounded-lg shadow-xl max-w-sm flex items-center gap-3">
            <span className="material-symbols-outlined text-2xl">info</span>
            <div>
              <p className="font-semibold text-sm">Coming Soon!</p>
              <p className="text-xs opacity-90 mt-0.5">Social login will be available soon.</p>
            </div>
          </div>
        </div>
      )}
