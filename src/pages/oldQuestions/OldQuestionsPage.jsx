...
function QuestionCard({ question, index, onClick }) {
  ...
  return (
    <motion.div
      ...
      onClick={onClick}
      className="group relative bg-white rounded-2xl border border-slate-200/80
    ...
    >
      {/* Top Accent Bar */}
      <div className={`h-1.5 bg-linear-to-r ${getYearGradient(question.year)}`} />
      ...
      <div className="p-5 flex flex-col h-full relative">
        ...
        <div className="flex items-start justify-between mb-4">
          <div
            className={`p-3 bg-linear-to-br ${getYearGradient(question.year)}
        ...
        {/* Click to View Hint */}
        <div className="mt-4 flex items-center justify-center gap-2 py-2.5 px-4
                        bg-slate-50 group-hover:bg-orange-50 
                        border border-slate-200 group-hover:border-orange-200
                        rounded-xl transition-all duration-300">
          <Eye size={16} className="text-slate-500 group-hover:text-orange-500" />
      ...
      {selectedYear && (
        <motion.div
          ...
          className="mt-3 flex items-center justify-between p-3 
                     bg-linear-to-r from-orange-50 to-orange-100/50
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <div>
              <p className="text-xs text-orange-600 font-medium">Filtering by</p>
              <p className="text-lg font-bold text-orange-700">{selectedYear}</p>
            </div>
          </div>
          <button
...
function NoCourseSelected() {
  return (
    ...
    >
      <div
        className="w-28 h-28 mx-auto mb-6 rounded-3xl bg-linear-to-br
      ...
      <p className="text-slate-500 max-w-md mx-auto mb-6 leading-relaxed">
        Please select a course from the filters on the left to view 
          ...
          >
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
              <div className="flex items-center gap-4">
                <div
                  className="p-3 bg-linear-to-br from-orange-500 to-orange-600
                ...
                <div className="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    {activeFilters.semesters.map((sem) => (
                      <span
                        key={sem}
                        className="px-3 py-1 bg-emerald-100 text-emerald-700 text-xs
                                   font-semibold rounded-full flex items-center gap-1"
                      >
                        <BookOpen size={12} />
                        Sem {sem}
                    ...
                    {selectedYear && (
                      <span
                        className="px-3 py-1 bg-purple-100 text-purple-700 text-xs
                                   font-semibold rounded-full flex items-center gap-1"
                      >
                        <Calendar size={12} />
                        {selectedYear}
